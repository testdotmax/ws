...
<div id="section_container">
 ...
 <div class="contents">
		...
		<input type="text" name="Username" id="item1" class="int" autocomplete="off" placeholder="微信号">
        
<input type="password" name="Password" id="item2"  value="" class="int" autocomplete="off" placeholder="密码">
